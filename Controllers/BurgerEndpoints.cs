...
public static class BurgerEndpoints
{
    public static void MapBurgerEndpoints (this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<Burger>, NotFound>> (int burgerid, ApiLeonardoAndradeContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (int burgerid, Burger burger, ApiLeonardoAndradeContext db) =>
        {
            var affected = await db.Burger
                ...
                .ExecuteUpdateAsync(setters => setters
                    ...
                    .SetProperty(m => m.Costo, burger.Costo)
                    );
        ...
        group.MapPost("/", async (Burger burger, ApiLeonardoAndradeContext db) =>
        {
        ...
        group.MapDelete("/{id}", async Task<Results<Ok, NotFound>> (int burgerid, ApiLeonardoAndradeContext db) =>
        {
            var affected = await db.Burger
                .Where(model => model.BurgerId == burgerid)
                .ExecuteDeleteAsync();
